...
export default function BusinessQuestions() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/business/get-questions`, {
          method: 'POST',
          headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/business/delete-question`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleUpdateQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/business/update-one-question`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleAddQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/business/add-business-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      const refreshResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/business/get-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
