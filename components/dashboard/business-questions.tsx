...
export default function BusinessQuestions() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://dev.wellnexai.com/api/business/get-questions`, {
          method: 'POST',
          headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/delete-question`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleUpdateQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/update-one-question`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleAddQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/add-business-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      const refreshResponse = await fetch(`https://dev.wellnexai.com/api/business/get-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
