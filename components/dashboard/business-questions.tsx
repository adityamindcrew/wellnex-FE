...
export default function BusinessQuestions() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://13.61.105.209/api/business/get-questions`, {
          method: 'POST',
          headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://13.61.105.209/api/business/delete-question`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleUpdateQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://13.61.105.209/api/business/update-one-question`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleAddQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://13.61.105.209/api/business/add-business-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
      ...
      const refreshResponse = await fetch(`https://13.61.105.209/api/business/get-questions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
