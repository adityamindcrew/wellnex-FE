...
export default function BusinessKeywords() {
  ...
  const fetchKeywords = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/business/getKeywords`, {
        method: 'POST',
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/business/deleteKeyword`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleUpdateKeyword = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/business/updateOneKeyword`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token.trim()}`
