  ...
  const fetchBusinessDetails = async () => {
    try {
      ...
      if (data.data) {
        ...
        if (data.data.logo) {
          setLogoUrl(`${process.env.NEXT_PUBLIC_UPLOADS_URL}/business-logos/${data.data.logo}`);
          localStorage.setItem('businessLogo', `${process.env.NEXT_PUBLIC_UPLOADS_URL}/business-logos/${data.data.logo}`);
        }
