  ...
  const fetchBusinessDetails = async () => {
    try {
      ...
      if (data.data) {
        ...
        if (data.data.logo) {
          setLogoUrl(`https://dev.wellnexai.com/uploads/business-logos/${data.data.logo}`);
          localStorage.setItem('businessLogo', `https://dev.wellnexai.com/uploads/business-logos/${data.data.logo}`);
        }
