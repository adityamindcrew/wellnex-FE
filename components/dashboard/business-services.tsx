...
export default function BusinessServices() {
  ...
  const fetchServices = async () => {
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/getServicesList`, {
        method: 'POST',
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/deleteService`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleUpdateService = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://dev.wellnexai.com/api/business/updateOneService`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
