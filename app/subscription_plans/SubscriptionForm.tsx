...
const SubscriptionForm = ({ priceId }: { priceId: string }) => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                const subscriptionResponse = await fetch(`https://dev.wellnexai.com/api/subscription/status`, {
                    headers: {
                ...
                // Fetch saved cards
                const cardsResponse = await fetch(`https://dev.wellnexai.com/api/subscription/cards`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`
                    }
                });
    ...
    const confirmRemoveCard = async () => {
        try {
            const response = await fetch(`https://dev.wellnexai.com/api/subscription/cards/${cardToRemove}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
                }
