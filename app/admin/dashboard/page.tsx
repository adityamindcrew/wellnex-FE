...
const Index = () => {
  ...
  const fetchSubscriptionCounts = async () => {
    try {
      ...
      const response = await fetch(`http://13.61.105.209/api/admin/subscriptions/counts`, {
        method: 'GET',
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://13.61.105.209/api/admin/business/${businessToDelete}`, {
        method: 'DELETE',
        headers: {
  ...
  const handleEditSubmit = async (payload: any) => {
    ...
    try {
      ...
      const response = await fetch(`http://13.61.105.209/api/business/updateBusinessDetail`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
                        ...
                        <TableRow key={business._id}>
                          <TableCell>
                            <div className="flex items-center gap-2">
                              {business.logo ? (
                                <img
                                  src={`http://13.61.105.209/uploads/business-logos/${business.logo}`}
                  ...
                  onSubmit={async (e) => {
                    ...
                    if (logoFile && logoFile instanceof File && logoFile.size > 0) {
                      ...
                      try {
                        ...
                        let uploadRes;
                        try {
                          uploadRes = await fetch(`http://13.61.105.209/api/business/updateBusinessDetail`, {
                            method: 'PUT',
                            headers: {
                              'Authorization': `Bearer ${token}`,
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    {editingBusiness.logo && (
                      <img
                        src={`http://13.61.105.209/uploads/business-logos/${editingBusiness.logo}`}
                        alt="Current Logo"
