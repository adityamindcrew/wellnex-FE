...
const Index = () => {
  ...
  const fetchSubscriptionCounts = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/admin/subscriptions/counts`, {
        method: 'GET',
        headers: {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/admin/business/${businessToDelete}`, {
        method: 'DELETE',
        headers: {
  ...
  const handleEditSubmit = async (payload: any) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_API_URL}/business/updateBusinessDetail`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
                  ...
                  onSubmit={async (e) => {
                    ...
                    if (logoFile && logoFile instanceof File && logoFile.size > 0) {
                      ...
                      try {
                        ...
                        let uploadRes;
                        try {
                          uploadRes = await fetch(`${process.env.NEXT_API_URL}/business/updateBusinessDetail`, {
                            method: 'PUT',
                            headers: {
                              'Authorization': `Bearer ${token}`,
