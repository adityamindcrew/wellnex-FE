    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-white rounded-xl shadow-sm mt-16 p-8">
        ...
        <div className="max-w-xl mx-auto mt-4">
          <h2 className="text-lg font-semibold mb-2 mt-20">1. Step 1: Copy Your Unique Embed Code</h2>
          ...
          <p className="text-[#000000] mb-4">We're here to make setup simple so you can start converting visitors into clients right away.</p>
