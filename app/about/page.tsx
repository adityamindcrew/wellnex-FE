  ...
  <Header/>
      <section className="flex flex-col md:flex-row max-w-5xl mx-auto bg-white rounded-xl shadow-sm mt-12 p-8 gap-8">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <p className="text-[#000000] text-base md:text-md mb-3">
          ...
          <p className="text-[#000000] text-base md:text-md mb-3">
          In a fast-paced world where customers expect instant answers, WellnexAI makes it effortless to stay connected, capture leads, and grow while you stay focused on what you do best.          </p>
          <p className="text-[#000000] text-base md:text-md mb-3">
      ...
      <section className="flex flex-col md:flex-row max-w-5xl mx-auto bg-white rounded-xl shadow-sm mt-8 p-8 gap-8">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="mt-4 text-sm text-[#475569]">Sara Soltanzadeh, Founder of WellnexAI</div>
        </div>
      </section>
